...
namespace EssentialFrame.Cqrs.Commands.Scheduling.Autofac.Executors;

internal sealed class AutofacCommandStoreExecutor : ICommandStoreExecutor
{
    private readonly ILifetimeScope _lifetimeScope;

    public AutofacCommandStoreExecutor(ILifetimeScope lifetimeScope) =>
