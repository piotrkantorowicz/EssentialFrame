...
public class CannotCreateOutdatedPostRule : BusinessRule
{
    private readonly Date _expiration;

    public CannotCreateOutdatedPostRule(Guid domainObjectIdentifier, Type businessObjectType, Date expiration) : base(
